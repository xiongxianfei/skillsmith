...
| --- | --- | --- | --- | --- |
| `docs/plans/2026-06-16-editor-source-plus-companion-language-optimization.md` | active | M2. Editor prompt implementation | code-review | M2 implementation is review-requested after prompt and README updates with validation. |
