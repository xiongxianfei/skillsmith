...
| --- | --- | --- | --- | --- |
| `docs/plans/2026-06-16-editor-source-plus-companion-language-optimization.md` | active | M2. Editor prompt implementation | implement | M1 closed cleanly in code-review; ready to implement the prompt and README mirror slice. |
